...
bloques = [
    ...
    ("", "corredor completo de 74 km. Pero los cuatro sectores que los aportan caen todos en el"),
    ("", "descenso de Calarcá, dentro de los 45 km de la estación 244. Ninguna de las dos"),
    ("", "definiciones es obviamente la correcta, así que se publican las dos con su denominador"),
    ("", "declarado y no se escoge una en silencio."),
    ("", ""),
    ("MARCAS", ""),
...
for t in [
    ...
    "reparte sobre los 74 km del corredor que la ANSV nombra; la segunda sobre los 45 km donde caen los cuatro",
    "sectores que los aportan. La segunda es mayor porque concentra la misma mortalidad en menos kilómetros.",
    "",
