...
export const SEGURIDAD_VIAL = {
  ...
  tasaPaso:       { valor: '7,66', n: 7.6605, marca: 'CP' as Marca, fuente: CALC,
                    nota: 'Los mismos 42 fallecidos sobre los 45 km del descenso Calarcá – Cajamarca, donde caen los seis sectores críticos, con el TPD medido de la estación 244. Es mayor porque concentra la misma mortalidad en menos kilómetros.' },
...
export const GEO = {
  ...
  coberturaMedia:   { valor: '840,2 m',      n: 840.2,   marca: 'CP' as Marca, fuente: CALC,
                      nota: 'Promedio de la cobertura sobre los 1.500 puntos del perfil.' },
